...
##### [generic-function](b65b) `ultralisp-client:get-project-sources` project
...
##### [generic-function](6acc) `ultralisp-client:get-project-systems` project

<a id="x-28ULTRALISP-CLIENT-3AGET-PROJECT-TAGS-20GENERIC-FUNCTION-29"></a>

##### [generic-function](2c3a) `ultralisp-client:get-project-tags` project
...
##### [function](8eef) `ultralisp-client:get-all-tags`
...
##### [function](4fe1) `ultralisp-client:get-project-by-name` name

<a id="x-28ULTRALISP-CLIENT-3AGET-PROJECTS-BY-TAG-20FUNCTION-29"></a>

##### [function](f966) `ultralisp-client:get-projects-by-tag` tag
...
#### [package](5209) `ultralisp-client/client`
...
##### [function](26b8) `ultralisp-client/client:ensure-connected` &optional (url \*url\*)
...
#### [package](f97e) `ultralisp-client/lowlevel`
...
###### [class](26cb) `ultralisp-client/lowlevel:api` (client)
...
###### [class](26cb) `ultralisp-client/lowlevel:project2` ()
...
###### [reader](26cb) `ultralisp-client/lowlevel:project2-created-at` (project2) (:created-at = nil)
...
###### [reader](26cb) `ultralisp-client/lowlevel:project2-deleted` (project2) (:deleted = nil)
...
###### [reader](26cb) `ultralisp-client/lowlevel:project2-description` (project2) (:description = nil)
...
###### [reader](26cb) `ultralisp-client/lowlevel:project2-id` (project2) (:id = nil)
...
###### [reader](26cb) `ultralisp-client/lowlevel:project2-latest` (project2) (:latest = nil)
...
###### [reader](26cb) `ultralisp-client/lowlevel:project2-name` (project2) (:name = nil)
...
###### [reader](26cb) `ultralisp-client/lowlevel:project2-updated-at` (project2) (:updated-at = nil)
...
###### [reader](26cb) `ultralisp-client/lowlevel:project2-version` (project2) (:version = nil)
...
###### [class](26cb) `ultralisp-client/lowlevel:release-info` ()
...
###### [reader](26cb) `ultralisp-client/lowlevel:release-info-archive-path` (release-info) (:archive-path = nil)
...
###### [reader](26cb) `ultralisp-client/lowlevel:release-info-content-sha1` (release-info) (:content-sha1 = nil)
...
###### [reader](26cb) `ultralisp-client/lowlevel:release-info-file-size` (release-info) (:file-size = nil)
...
###### [reader](26cb) `ultralisp-client/lowlevel:release-info-md5sum` (release-info) (:md5sum = nil)
...
###### [reader](26cb) `ultralisp-client/lowlevel:release-info-project-name` (release-info) (:project-name = nil)
...
###### [reader](26cb) `ultralisp-client/lowlevel:release-info-project-prefix` (release-info) (:project-prefix = nil)
...
###### [reader](26cb) `ultralisp-client/lowlevel:release-info-project-url` (release-info) (:project-url = nil)
...
###### [reader](26cb) `ultralisp-client/lowlevel:release-info-system-files` (release-info) (:system-files = nil)
...
###### [class](26cb) `ultralisp-client/lowlevel:search-result` ()
...
###### [reader](26cb) `ultralisp-client/lowlevel:search-result-documentation` (search-result) (:documentation = nil)
...
###### [reader](26cb) `ultralisp-client/lowlevel:search-result-package` (search-result) (:package = nil)
...
###### [reader](26cb) `ultralisp-client/lowlevel:search-result-symbol` (search-result) (:symbol = nil)
...
###### [reader](26cb) `ultralisp-client/lowlevel:search-result-system` (search-result) (:system = nil)
...
###### [reader](26cb) `ultralisp-client/lowlevel:search-result-type` (search-result) (:type = nil)
...
###### [class](26cb) `ultralisp-client/lowlevel:source` ()
...
###### [reader](26cb) `ultralisp-client/lowlevel:source-created-at` (source) (:created-at = nil)
...
###### [reader](26cb) `ultralisp-client/lowlevel:source-deleted` (source) (:deleted = nil)
...
###### [reader](26cb) `ultralisp-client/lowlevel:source-id` (source) (:id = nil)
...
###### [reader](26cb) `ultralisp-client/lowlevel:source-latest` (source) (:latest = nil)
...
###### [reader](26cb) `ultralisp-client/lowlevel:source-params` (source) (:params = nil)
...
###### [reader](26cb) `ultralisp-client/lowlevel:source-project-id` (source) (:project-id = nil)
...
###### [reader](26cb) `ultralisp-client/lowlevel:source-project-version` (source) (:project-version = nil)
...
###### [reader](26cb) `ultralisp-client/lowlevel:source-release-info` (source) (:release-info = nil)
...
###### [reader](26cb) `ultralisp-client/lowlevel:source-systems-info` (source) (:systems-info = nil)
...
###### [reader](26cb) `ultralisp-client/lowlevel:source-type` (source) (:type = nil)
...
###### [reader](26cb) `ultralisp-client/lowlevel:source-updated-at` (source) (:updated-at = nil)
...
###### [reader](26cb) `ultralisp-client/lowlevel:source-version` (source) (:version = nil)
...
###### [class](26cb) `ultralisp-client/lowlevel:system-info` ()
...
###### [reader](26cb) `ultralisp-client/lowlevel:system-info-author` (system-info) (:author = nil)
...
###### [reader](26cb) `ultralisp-client/lowlevel:system-info-dependencies` (system-info) (:dependencies = nil)
...
###### [reader](26cb) `ultralisp-client/lowlevel:system-info-description` (system-info) (:description = nil)
...
###### [reader](26cb) `ultralisp-client/lowlevel:system-info-filename` (system-info) (:filename = nil)
...
###### [reader](26cb) `ultralisp-client/lowlevel:system-info-license` (system-info) (:license = nil)
...
###### [reader](26cb) `ultralisp-client/lowlevel:system-info-long-description` (system-info) (:long-description = nil)
...
###### [reader](26cb) `ultralisp-client/lowlevel:system-info-maintainer` (system-info) (:maintainer = nil)
...
###### [reader](26cb) `ultralisp-client/lowlevel:system-info-name` (system-info) (:name = nil)
...
###### [reader](26cb) `ultralisp-client/lowlevel:system-info-path` (system-info) (:path = nil)
...
###### [reader](26cb) `ultralisp-client/lowlevel:system-info-project-name` (system-info) (:project-name = nil)
...
###### [class](26cb) `ultralisp-client/lowlevel:tag` ()
...
###### [reader](26cb) `ultralisp-client/lowlevel:tag-name` (tag) (:name = nil)
...
###### [reader](26cb) `ultralisp-client/lowlevel:tag-project-count` (tag) (:project-count = nil)
...
##### [generic-function](26cb) `ultralisp-client/lowlevel:get-all-tags` client
...
##### [generic-function](26cb) `ultralisp-client/lowlevel:get-project-by-name` client name
...
##### [generic-function](26cb) `ultralisp-client/lowlevel:get-project-sources` client project-id
...
##### [generic-function](26cb) `ultralisp-client/lowlevel:get-project-systems` client project-id
...
##### [generic-function](26cb) `ultralisp-client/lowlevel:get-project-tags` client project-id

Retrieve all tags of a single project.

<a id="x-28ULTRALISP-CLIENT-2FLOWLEVEL-3AGET-PROJECTS-BY-TAG-20GENERIC-FUNCTION-29"></a>

##### [generic-function](26cb) `ultralisp-client/lowlevel:get-projects-by-tag` client tag &key limit page-key

Returns project market by a given tag.

<a id="x-28ULTRALISP-CLIENT-2FLOWLEVEL-3ARPC-DISCOVER-20GENERIC-FUNCTION-29"></a>

##### [generic-function](26cb) `ultralisp-client/lowlevel:rpc-discover` client

<a id="x-28ULTRALISP-CLIENT-2FLOWLEVEL-3ASEARCH-SYMBOLS-20GENERIC-FUNCTION-29"></a>

##### [generic-function](26cb) `ultralisp-client/lowlevel:search-symbols` client term &key limit page-key
...
##### [function](26cb) `ultralisp-client/lowlevel:make-api`


[0dbb]: https://github.com/ultralisp/ultralisp-client
[73c0]: https://github.com/ultralisp/ultralisp-client/actions
[5209]: https://github.com/ultralisp/ultralisp-client/blob/bcad92c8a382b3cffbb2e79f7aa66245155fcfda/src/client.lisp#L1
[26b8]: https://github.com/ultralisp/ultralisp-client/blob/bcad92c8a382b3cffbb2e79f7aa66245155fcfda/src/client.lisp#L18
[f30f]: https://github.com/ultralisp/ultralisp-client/blob/bcad92c8a382b3cffbb2e79f7aa66245155fcfda/src/core.lisp#L1
[f97e]: https://github.com/ultralisp/ultralisp-client/blob/bcad92c8a382b3cffbb2e79f7aa66245155fcfda/src/lowlevel.lisp#L1
[26cb]: https://github.com/ultralisp/ultralisp-client/blob/bcad92c8a382b3cffbb2e79f7aa66245155fcfda/src/lowlevel.lisp#L8
[4fe1]: https://github.com/ultralisp/ultralisp-client/blob/bcad92c8a382b3cffbb2e79f7aa66245155fcfda/src/projects.lisp#L15
[f966]: https://github.com/ultralisp/ultralisp-client/blob/bcad92c8a382b3cffbb2e79f7aa66245155fcfda/src/projects.lisp#L20
[2c3a]: https://github.com/ultralisp/ultralisp-client/blob/bcad92c8a382b3cffbb2e79f7aa66245155fcfda/src/projects.lisp#L36
[6acc]: https://github.com/ultralisp/ultralisp-client/blob/bcad92c8a382b3cffbb2e79f7aa66245155fcfda/src/projects.lisp#L45
[b65b]: https://github.com/ultralisp/ultralisp-client/blob/bcad92c8a382b3cffbb2e79f7aa66245155fcfda/src/projects.lisp#L53
[8eef]: https://github.com/ultralisp/ultralisp-client/blob/bcad92c8a382b3cffbb2e79f7aa66245155fcfda/src/tags.lisp#L11
